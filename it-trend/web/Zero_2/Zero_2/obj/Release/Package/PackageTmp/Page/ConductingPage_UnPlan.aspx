<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConductingPage_UnPlan.aspx.cs"
      MasterPageFile="Conducting.master" Inherits="Zero_2.Page.ConductingPage_UnPlan" %>
   ...
   <div class ="condinfo" runat="server">
        <div class="lr">            
            <div class="leftcond" style="float:left;">
                <asp:Button ID="Button1" CssClass="button button1" runat="server" Text="Техника безопасности" Width="200px" Height="40px" OnClick="Button1_Click"
                    style="border-top-right-radius:4px; border-bottom-right-radius:4px; border:none;
                    margin-top:14px; cursor:pointer;"/>
                <br />            
                <asp:Button ID="Button2" CssClass="button button1" runat="server" Text="Электробезопасность"  Width="200px" Height="40px" OnClick="Button2_Click"
                    style="border-top-right-radius:4px; border-bottom-right-radius:4px; border:none;
            ...
            <div class="rightcond" style="float:right;">
                <div class="left" style="float:left;">
                    ...
                    <asp:Label ID="Label3" runat="server"
                        Text="проходящих внеплановую аттестацию по дисциплине:" Height="31px"
                        Font-Names="Segoe UI" Font-Size="15px"> </asp:Label>     
                    <br />     
